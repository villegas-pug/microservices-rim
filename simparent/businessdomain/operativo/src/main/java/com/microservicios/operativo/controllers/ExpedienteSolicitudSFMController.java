...
public class ExpedienteSolicitudSFMController {
   ...
   @PostMapping( path = { "/saveAllExpedienteSolicitud" }, consumes = { MediaType.MULTIPART_FORM_DATA_VALUE } )
   public ResponseEntity<?> saveAllExpedienteSolicitud(@RequestPart MultipartFile file){
   ...
   @GetMapping( path = { "/getMetadataFilesExpedienteSolicitud" } )
   public ResponseEntity<?> getMetadataFilesExpedienteSolicitud(){
   ...
   @GetMapping( path = "/findByNumeroExpeOfSolicitud" )
   public ResponseEntity<?> findByNumeroExpeOfSolicitud(@RequestParam String numeroExpediente) {
      ...
      return ResponseEntity.ok().body(
                                    Response
                                       ...
                                       .data(Arrays.asList(expedienteSolicitudSFM))
                                       .build());
   }
